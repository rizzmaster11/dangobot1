...
module.exports = class Help extends Command {
    ...
    if(!commandArg) {
      ...
      let contentAdmin = this.client.utils.commandsList(this.client, "administration");
      let adminEmbed = this.client.embedBuilder(this.client, message.author, this.client.language.titles.help.administration, contentAdmin, this.client.embeds.general_color, true);  
      
      let data = [];
      let embeds = [helpMenu, memberEmbed, ecoEmbed, utilityEmbed, modEmbed, musicEmbed, funEmbed, gwEmbed, adminEmbed];
      let embedNames = ["main_menu", "member", "economy",
       "utility", "moderation", "music", "fun", "giveaway", "administration"];
  ...
  async slashRun(interaction, args) {
    ...
    if(!commandArg) {
      ...
      let contentAdmin = this.client.utils.commandsList(this.client, "administration");
      let adminEmbed = this.client.embedBuilder(this.client, interaction.user, this.client.language.titles.help.administration, contentAdmin, this.client.embeds.general_color, true);  
