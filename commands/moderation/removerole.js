...
module.exports = class RemoveRole extends Command {
  ...
  async run(message, args) {
    ...
    message.channel.send({ embeds: [this.client.embedBuilder(this.client, message.author, this.client.embeds.title, this.client.language.moderation.role_removed.replace("<user>", member.user.username).replace("<role>", role), this.client.embeds.success_color)] });
  }
  async slashRun(interaction, args) {
    ...
    interaction.reply({ embeds: [this.client.embedBuilder(this.client, interaction.user, this.client.embeds.title, this.client.language.moderation.role_removed.replace("<user>", member.user.username).replace("<role>", role), this.client.embeds.success_color)], ephemeral: this.client.cmdConfig.removerole.ephemeral });
  }
};