const { ActionRowBuilder, StringSelectMenuBuilder, ComponentType, InteractionType } = require('discord.js');
...
module.exports = async (client, message, home, data) => {
  ...
  const collector = m.createMessageComponentCollector({ filter, componentType: ComponentType.StringSelect, time: 300000 });
